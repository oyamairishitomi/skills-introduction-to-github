...
![緑色のマージプルリクエストボタンのスクリーンショット](https://github.com/oyamairishitomi/skills-introduction-to-github/blob/main/.github/images/merge-pull-request-button.png?raw=true)
...
3. ブランチがマージされたら、もうそのブランチは必要ありません。ブランチを削除するには **Delete branch** をクリックしてください。
   ...
   ![ブランチ削除ボタンを示すスクリーンショット](https://github.com/oyamairishitomi/skills-introduction-to-github/blob/main/.github/images/delete-branch-button.png?raw=true)
